...
const BookModal = ({ book, onClose }) => {
  return (
    <div
      className="fixed bg-slate-100 bg-opacity-60 top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center"
      onClick={onClose}
    >
      <div
      ...
      >
        <AiOutlineClose
          ...
          onClick={onClose}
        />
        <h2 className="w-fit px-4 py-1 bg-red-600 rounded-lg">
          {book.publishYear}
        </h2>
